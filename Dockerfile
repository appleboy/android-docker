...
ENV ANDROID_SDK_URL="https://dl.google.com/android/repository/sdk-tools-linux-3859397.zip" \ 
    ANDROID_SDK_PLATFORMS="android-21,android-22,android-23,android-24,android-25,android-26,android-27" \
    ANDROID_BUILD_TOOLS="build-tools-22.0.1,build-tools-24.0.0,build-tools-24.0.1,build-tools-24.0.2,build-tools-24.0.3,build-tools-25.0.0,build-tools-25.0.1,build-tools-25.0.2,build-tools-25.0.3,build-tools-26.0.1,build-tools-26.0.2,build-tools-27.0.3" \ 
